<?php
	...
	$datas = read_data("SELECT * FROM categories WHERE category_id = $category_id");
...
<head>
  ...
  <meta name="keywords" content="">
	<title>Category Details - Living Barn Indonesia</title>
			...
			<div class="pt-10 sm:pt-20 lg:pt-2 pb-20 sm:pb-24 md:pb-28 lg:pb-40 sm:mx-auto sm:w-96 md:w-auto md:grid md:grid-cols-4 lg:grid-cols-6">
				...
				<form action="" method="POST" class="col-span-2">
					<section class="space-y-2 5">
						<h1 class="text-green-600 text-2xl font-bold font-mont">Category Details</h1>
						<p class="text-neutral-600">Access and edit comprehensive category details.</p>
					</section>
					...
					<section class="pt-7 grid grid-cols-2 gap-5">
						<div class="w-full space-y-1 col-span-2">
							...
							<input type="text" name="name" id="name" value="<?= $data["name"] ?>" required autofocus class="w-full p-4 text-neutral-800 bg-transparent ring-2 ring-neutral-400 ring-inset hover:ring-green-600 focus:ring-0 focus:ring-0 focus:outline-1 focus:outline-offset-0 focus:outline-green-600 rounded-xl">
						</div>
					</section>
					<?php endforeach ?>
